...
This is the general API reference guide used for writing API documentation.
...
Follow these guidelines to help you write better API reference documentation:
